...
#### Display and Audio
# Easy on the eyes.<br />Music to your ears.
...
## Contact
- [Twitter](https://twitter.com/mikeheddes)
- [Facebook](https://facebook.com/djmikeheddes)
- [YouTube](https://youtube.com/mikeheddes)
...
- [TensorFlow.js Core](https://github.com/tensorflow/tfjs-core), a flexible low-level API, formerly known as *deeplearn.js*.
- [TensorFlow.js Layers](https://github.com/tensorflow/tfjs-layers), a high-level API which implements functionality similar to [Keras](https://keras.io/).
...
via [script tags](https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_JavaScript_within_a_webpag) *or* by installing it from [NPM](https://www.npmjs.com/) and using a build tool like [Parcel](https://parceljs.org/) [WebPack](https://webpack.js.org/) or [Rollup](https://rollupjs.org/guide/en).
...
Add TensorFlow.js to your project using [yarn](https://yarnpkg.com/en/)
*or* [npm](https://docs.npmjs.com/cli/npm).
**Note:** Because we use ES2017syntax (such as `import`), this workflow assumes
you are using a modern browser
or a bundler/transpiler to convert your code to something older browsers understand.
See our [examples](https://github.com/tensorflow/tfjs-examples) to see how we use
[Parcel](https://parceljs.org/) to build our code. However you are free to use any build tool that you prefer.
...
See our [tutorials](https://js.tensorflow.org/tutorials/), [examples](https://github.com/tensorflow/tfjs-examples) and [documentation](https://js.tensorflow.org/api/latest/) for more details.
